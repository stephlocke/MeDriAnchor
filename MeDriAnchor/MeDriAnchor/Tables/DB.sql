...
BEGIN TRY
	...
	([ShadowType],[DBID],[DBServerID],[DBName],[DBUserName],[DBUserPassword],[DBIsLocal],[DBIsSource],[DBIsDestination],[Metadata_ID],[Environment_ID],[StageData])
	SELECT 'U',[DELETED].[DBID],[DELETED].[DBServerID],[DELETED].[DBName],[DELETED].[DBUserName],[DELETED].[DBUserPassword],[DELETED].[DBIsLocal],[DELETED].[DBIsSource],[DELETED].[DBIsDestination],[DELETED].[Metadata_ID],[DELETED].[Environment_ID],[DELETED].[StageData]
	FROM DELETED;
...
BEGIN TRY
	...
	INSERT INTO [MeDriAnchor].[DB_Shadow]
	([ShadowType],[DBID],[DBServerID],[DBName],[DBUserName],[DBUserPassword],[DBIsLocal],[DBIsSource],[DBIsDestination],[Metadata_ID],[Environment_ID],[StageData])
	SELECT 'I',[INSERTED].[DBID],[INSERTED].[DBServerID],[INSERTED].[DBName],[INSERTED].[DBUserName],[INSERTED].[DBUserPassword],[INSERTED].[DBIsLocal],[INSERTED].[DBIsSource],[INSERTED].[DBIsDestination],[INSERTED].[Metadata_ID],[INSERTED].[Environment_ID],[INSERTED].[StageData]
	FROM INSERTED;
...
BEGIN TRY
	...
	INSERT INTO [MeDriAnchor].[DB_Shadow]
	([ShadowType],[DBID],[DBServerID],[DBName],[DBUserName],[DBUserPassword],[DBIsLocal],[DBIsSource],[DBIsDestination],[Metadata_ID],[Environment_ID],[StageData])
	SELECT 'D',[DELETED].[DBID],[DELETED].[DBServerID],[DELETED].[DBName],[DELETED].[DBUserName],[DELETED].[DBUserPassword],[DELETED].[DBIsLocal],[DELETED].[DBIsSource],[DELETED].[DBIsDestination],[DELETED].[Metadata_ID],[DELETED].[Environment_ID],[DELETED].[StageData]
	FROM DELETED;
