...
CREATE TABLE [MeDriAnchor].[DBTableTieColumns] (
	...
	[IsIdentity]	      BIT	NOT NULL CONSTRAINT [DF_DBTableTieColumns_IsIdentity] DEFAULT ((0)),
...
BEGIN TRY
	...
	([ShadowType],[DBTableTieColumnsID],[TieID],[DBTableColumnID],[AnchorMnemonicRef],[RoleName],[TieJoinOrder],[TieJoinColumn],[Metadata_ID])
	SELECT 'U',[DELETED].[DBTableTieColumnsID],[DELETED].[TieID],[DELETED].[DBTableColumnID],[DELETED].[AnchorMnemonicRef],[DELETED].[RoleName],[DELETED].[TieJoinOrder],[DELETED].[TieJoinColumn],[DELETED].[Metadata_ID]
	FROM DELETED;
...
BEGIN TRY
	...
	INSERT INTO [MeDriAnchor].[DBTableTieColumns_Shadow]
	([ShadowType],[DBTableTieColumnsID],[TieID],[DBTableColumnID],[AnchorMnemonicRef],[RoleName],[TieJoinOrder],[TieJoinColumn],[Metadata_ID])
	SELECT 'I',[INSERTED].[DBTableTieColumnsID],[INSERTED].[TieID],[INSERTED].[DBTableColumnID],[INSERTED].[AnchorMnemonicRef],[INSERTED].[RoleName],[INSERTED].[TieJoinOrder],[INSERTED].[TieJoinColumn],[INSERTED].[Metadata_ID]
	FROM INSERTED;
...
BEGIN TRY
	...
	INSERT INTO [MeDriAnchor].[DBTableTieColumns_Shadow]
	([ShadowType],[DBTableTieColumnsID],[TieID],[DBTableColumnID],[AnchorMnemonicRef],[RoleName],[TieJoinOrder],[TieJoinColumn],[Metadata_ID])
	SELECT 'D',[DELETED].[DBTableTieColumnsID],[DELETED].[TieID],[DELETED].[DBTableColumnID],[DELETED].[AnchorMnemonicRef],[DELETED].[RoleName],[DELETED].[TieJoinOrder],[DELETED].[TieJoinColumn],[DELETED].[Metadata_ID]
	FROM DELETED;
